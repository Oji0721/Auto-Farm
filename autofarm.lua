...
ImageButton.Image = "https://www.roblox.com/library/14419003369/img-727913"
...
spawn(function()
    ...
    Main:Button("Instant Chest Bypass ( ON/OFF )",function()
        loadstring(game:HttpGet("https://apitesthmt.000webhostapp.com/chest"))()
    end)

    
    Main:Seperator("Main Boss")
    ...
    Main:Toggle("Auto Farm Gun Mastery (Wait Update)",_G.AutoFarmGunMastery,function(value)
    ...
    Main:Slider("Kill At %",1,100,50,function(value)
...
local AttackList = {"5", "10"}
_G.FastAttackDelay = "0.175"
Main:Dropdown("Buff Fast Attack", AttackList,function(MakoGay)
...
Main:Toggle("Bypass Fast Attack (Not Kick) ",true,function(value)
...
spawn(function()
    ...
    Main:Button("Remove Attack",false,function(value)
    getgenv().A = require(game:GetService("ReplicatedStorage").CombatFramework.RigLib).wrapAttackAnimationAsync 
getgenv().B = require(game.Players.LocalPlayer.PlayerScripts.CombatFramework.Particle).play
spawn(function()
    ...
    Main:Button("Delete Attack Fix",false,function(d)
    ...
    N:Seperator("Misc Bone")
    
    BoneCheck = N:Label("Your Bone : Third World ")
    ...
    local BoneFarm = N:Toggle("Auto Farm Bone",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
    ...
    N:Toggle("Auto Random Surprise",_G.Auto_Random_Bone,function(value)
    ...
    N:Seperator("Dough Boss")
    
        local MobKilled = N:Label("Killed")
    ...
    N:Toggle("Auto Farm Katakuri",_G.AutoDoughtBoss,function(value)
    ...
    N:Toggle("Auto Kill Dough King", _G.Autodoughking,function(value)
    ...
    if World2 then
RaceV4:Label("Your Not In Third Sea!")

M:Seperator("Sea 2")
        M:Toggle("Auto Third Sea ( Sea 3 )",_G.AutoThirdSea,function(value)
            _G.AutoThirdSea = value
...
M:Toggle("Auto Dark Coat ( Beta )",_G.Auto_Dark_Coat,function(vu)
	Auto_Dark_Coat = vu
...
RaceV4:Seperator("Mirage Island Ã°Å¸ÂÂÃ¯Â¸Â")

local FM = RaceV4:Label('Your Not In Third Sea!!')
local Mirragecheck = RaceV4:Label('Yout Not In Third Sea!!')

task.spawn(function()
            while task.wait() do
                pcall(function()
                    if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
                        FM:Set("5/5 Ã°Å¸Å’â€¢: Moon Status")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" then
                        FM:Set("4/5 Ã°Å¸Å’â€“ : Moon Status")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709143733" then
                        FM:Set("3/5 Ã°Å¸Å’â€” : Moon Status")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709150401" then
                        FM:Set("2/5 Ã°Å¸Å’Ëœ : Moon Status")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149680" then
                        FM:Set("1/5 Ã°Å¸Å’Ëœ : Moon Status")
                    else
                        FM:Set("0/5 Ã°Å¸Å’Ëœ : Moon Status")
                    end
                end)
            end
end)
...
spawn(function()
    ...
    Mirragecheck:Set('Ã¢Å“â€¦ : Mirage Island is Spawning')
    else
      Mirragecheck:Set('Ã¢ÂÅ’ : Mirage Island Not Spawning ' )end
            end
        end)
end)    
...
M:Seperator("Sea Beasts")

M:Toggle("Auto Farm Sea Beasts",_G.SeaBeasts1,function(value)
 _G.SeaBeasts1 = value
...
spawn(function()
    ...
    M:Seperator("Misc Soul Guitar")
    
M:Toggle("Auto Soul Guitar ( Beta )",_G.AutoNevaSoulGuitar,function(value)
...
spawn(function()
	...
	M:Seperator("Misc Tushita")

   M:Toggle("Auto Holy Torch ( Beta )",_G.AutoHolyTorch,function(value)
...
M:Toggle("Auto Tushita Boss ( Beta )", _G.Autotushita,function(value)
...
local Total_Elite_Hunter = M:Label("Elite Hunter")
    ...
    M:Seperator("Misc Hallow Scythe")
    ...
    M:Seperator("Misc Dark Dagger")
    
    M:Toggle("Auto Kill Rip_Indra",_G.AutoDarkDagger,function(value)
...
if World3 then
    ...
    RaceV4:Toggle("Auto Summon Mirage Island",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
for _,v in next, workspace.Boats.PirateBrigade:GetDescendants() do
    ...
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.CFrame
     if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
        ...
        RaceV4:Button("Farm Chest Mirage Island",function()
        loadstring(game:HttpGet('https://raw.githubusercontent.com/Chetdithglon/AN_HUB/main/autochestvip'))()
        end)

   RaceV4:Seperator("Mirage & Gear")
        RaceV4:Toggle("Teleport To Mirage Island",getgenv().TPMystic,function(value)
    ...
    RaceV4:Toggle("Teleport To Gear",false,function(value)
...
spawn(function()
    ...
    RaceV4:Button("Remove Fog",function()
        game.Lighting.Sky:Destroy()
        end)

   RaceV4:Seperator("Awakening V4")

RaceV4:Toggle("Auto Use Awakening",getgenv().AutoAwakeningRace,function(value)
...
RaceV4:Button("Teleport To Ancient Clock",function()
for _,v in next, workspace:GetDescendants() do
  ...
  RaceV4:Button("Teleport Angel Door",function()
  ...
  RaceV4:Toggle("Auto Complete Trial Fish",false,function(v)
...
spawn(function()
    pcall(function()
      ...
      RaceV4:Toggle("Auto Complete Trial Ghoul/Human",nil,function(value)
...
spawn(function()
    while wait() do
        ...
        RaceV4:Button("Auto Complete Trial Mink",function(t)
...
RaceV4:Button("Auto Complete Trial Angel",function(t)
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Map.SkyTrial.Model.FinishPart.CFrame
        end)

        RaceV4:Button("Auto Complete Trial Cyborg",function(t)
...
spawn(function()
    ...
    R:Toggle("ESP Player",false,function(a)
        ESPPlayer = a
	UpdatePlayerChams()
    end)
    
    R:Toggle("ESP Chest",false,function(a)
        ChestESP = a
	UpdateChestChams() 
    end)
    
    R:Toggle("ESP Fruit",false,function(a)
        DevilFruitESP = a
    ...
    R:Toggle("ESP Real Fruit",RealFruitESP,function(a)
        RealFruitESP = a
	UpdateRealFruitChams() 
    end)
    
    R:Toggle("ESP Flower",false,function(a)
        FlowerESP = a
	UpdateFlowerChams() 
    end)
    spawn(function()
...
R:Toggle("ESP Island",IslandESP,function(value)
        IslandESP = value
        while IslandESP do wait()
            UpdateIslandESP() 
        end
    end)
    R:Toggle("ESP NPC", false, function(nec)
    NpcESP = nec
end)
spawn(function()
    while wait() do
    ...
    T:Button("Teleport Old World ( Sea 1 )",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    
    T:Button("Teleport Second Sea ( Sea 2 )",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    
    T:Button("Teleport Third Sea ( Sea 3 )",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    
    T:Button("Teleport Sea Beast",function()
        for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
            if v:FindFirstChild("HumanoidRootPart") then
...
T:Seperator("Island Tween")
    ...
    T:Toggle("Teleport Island ( Tween )",false,function(value)
...
T:Seperator("Island Bypass")

T:Toggle('Teleport Island ( Bypass )', BypassTP, function(vale)
  BypassTP = vale
end)
...
if World1 then
    T:Button("Start Island",function()
        if BypassTP then
    ...
    T:Button("Marine Start",function()
        if BypassTP then
    ...
    T:Button("Pirate Village",function()
        if BypassTP then
    ...
    T:Button("Frozen Village", function()
        if BypassTP then
    ...
    T:Button("Sky island 1 ",function()
        if BypassTP then
    ...
    T:Button("Sky island 2 ",function()
        if BypassTP then
    ...
    T:Button("Sky island 3 ",function()
        if BypassTP then
    ...
    T:Button("Sky island 4 ",function()
        if BypassTP then
    ...
    T:Button("Magma Village",function()
        if BypassTP then
    ...
    T:Button("UndeyWater City",function()
        if BypassTP then
    ...
    T:Button("Fountain City",function()
        if BypassTP then
    ...
    T:Button("House Cyborg's",function()
        if BypassTP then
    ...
    T:Button("Shank's Room",function()
        if BypassTP then
...
elseif World2 then
    ...
    T:Button("Kingdom of Rose",function()
        if BypassTP then
    ...
    T:Button("Flamingo Room",function()
        if BypassTP then
    ...
    T:Button("Grave Island",function()
        if BypassTP then
    ...
    T:Button("Snow Mountain",function()
        if BypassTP then
    ...
    T:Button("Forgotten Island",function()
        if BypassTP then
    ...
    T:Button("Usoapp Island",function()
        if BypassTP then
    ...
    T:Button("Minisky Island",function()
        if BypassTP then
...
elseif World3 then
    ...
    T:Button("Hydra Island",function()
        if BypassTP then
    ...
    T:Button("Castle on the Sea",function()
        if BypassTP then
    ...
    T:Button("Floating Turtle",function()
        if BypassTP then
    ...
    T:Button("Secret Temple",function()
        if BypassTP then
    ...
    T:Button("Friendly Arena",function()
        if BypassTP then
    ...
    T:Button("Beautiful Pirate Domain",function()
        if BypassTP then
    ...
    T:Button("Peanut Island",function()
        if BypassTP then
    ...
    T:Button("Chocolate Island",function()
        if BypassTP then
    ...
    T:Button("Ice Cream Island",function()
        if BypassTP then
    ...
    T:Button("Haunted Castle",function()
        if BypassTP then
    ...
    T:Button("Cake Loaf ( Katakuri )",function()
        if BypassTP then
    ...
    T:Button("Sea Of Treats",function()
        if BypassTP then
...
S:Button("Random Race (Use 3K Fragments)", function()
	...
	pcall(function()
		...
		game.Players.LocalPlayer.PlayerGui.Main.FruitInventory.Visible = true -- Ã Â¹â‚¬Ã Â¸â€ºÃ Â¸Â´Ã Â¸â€Ã Â¹â€žÃ Â¸Â§Ã Â¹â€°Ã Â¸â€“Ã Â¸Â¶Ã Â¸â€¡Ã Â¸Ë†Ã Â¸Â°Ã Â¹â‚¬Ã Â¸Å Ã Â¹â€¡Ã Â¸â€žÃ Â¹â€žÃ Â¸â€Ã Â¹â€°
...
spawn(function()
    ...
    D:Toggle("Auto Farm Fruit",_G.Grabfruit,function(value)
    _G.Grabfruit = value
    end)
    spawn(function()
			while wait(.1) do
...
Misc:Textbox("Paste Job Id Text","beta",function(vu)
_G.Job = vu
end)

Misc:Button('Join Job Id', function()
...
CheckAntiCheatBypass()
  Notification("Anti Cheat Bypass Activated Ã¢Å“â€¦")
end)
...
Misc:Button("Item Cap", function(value)
    ...
    Misc:Toggle("No Clip",_G.NOCLIP,function(value)
        _G.NOCLIP = value
    end)
...
spawn(function()
    ...
    Misc:Seperator("Webhook Discord")
	    Misc:Button("Webhook",function()
...
local url = "https://discord.com/api/webhooks/1127152424289837096/hDmssgykKoAbdB-uK0O2S1roKfWIJ78WBR3asc-b_BZHPvt5or__-SUfT7oOJv6NK_90"
local data = {
   ["content"] = "",
   ["embeds"] = {
       {
                ...
                if ac and ac.equipped then
                    task.spawn(
                        ...
                        if tick() - cdnormal > 0.175 then
                            ...
                            ac.humanoid:LoadAnimation(Animation):Play(1,1) --Ã Â¸â€”Ã Â¹Ë†Ã Â¸Â²Ã Â¹â€žÃ Â¸Â¡Ã Â¹Ë†Ã Â¸â€”Ã Â¸Â³Ã Â¸â€¡Ã Â¸Â²Ã Â¸â„¢Ã Â¹ÂÃ Â¸ÂÃ Â¹â€°Ã Â¹â‚¬Ã Â¸â€ºÃ Â¹â€¡Ã Â¸â„¢ (1,1)
